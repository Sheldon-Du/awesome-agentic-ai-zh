...
- [**PleasePrompto/notebooklm-skill**](https://github.com/PleasePrompto/notebooklm-skill) ★ 6.8k+ — NotebookLM Skill（浏览器***自动***化），用 Claude Code ***直接***查你 NotebookLM ***里***的文件，回答带 citation
...
- [**anthropics/skills**](https://github.com/anthropics/skills) ★ 144k+ — Anthropic **官方** Skills 集合，docx / xlsx / pptx / pdf ***处理******直接***内建
- [**tfriedel/claude-office-skills**](https://github.com/tfriedel/claude-office-skills) ★ 646 — ***补强***版 Office skills（PPTX/DOCX/XLSX/PDF），含***自动***化 workflow
...
- [**atlassian/atlassian-mcp-server**](https://github.com/atlassian/atlassian-mcp-server) ★ 745 — Atlassian **官方** Remote MCP（Jira、Confluence）
...
- [**WenyuChiou/ai-research-skills**](https://github.com/WenyuChiou/ai-research-skills) ★ 83 — 14 个研究流程 skill，5-plugin marketplace
- [**WenyuChiou/research-hub**](https://github.com/WenyuChiou/research-hub) ★ 21 — Zotero + Obsidian + NotebookLM ***集成*** workspace
...
- [**leemysw/feishu-docx**](https://github.com/leemysw/feishu-docx) ★ 213 — 飞书（Lark）docs / sheet / bitable ↔ Markdown，含 Claude Skills ***支持***
