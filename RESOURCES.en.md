...
- [**PleasePrompto/notebooklm-skill**](https://github.com/PleasePrompto/notebooklm-skill) ★ 6.8k+ — NotebookLM Skill, citation-backed answers from your uploaded docs
...
- [**taylorwilsdon/google_workspace_mcp**](https://github.com/taylorwilsdon/google_workspace_mcp) ★ 2.3k+ — full Workspace stack (Gmail, Calendar, Docs, Sheets, Slides, Drive) in one server

### Dev Collaboration

- [**github/github-mcp-server**](https://github.com/github/github-mcp-server) ★ 29k+ — GitHub **official** MCP for issues / PRs / repos
- [**atlassian/atlassian-mcp-server**](https://github.com/atlassian/atlassian-mcp-server) ★ 745 — Atlassian **official** Remote MCP (Jira, Confluence)
...
- [**WenyuChiou/ai-research-skills**](https://github.com/WenyuChiou/ai-research-skills) ★ 83 — 14 research-workflow skills as a 5-plugin marketplace
...
- [**leemysw/feishu-docx**](https://github.com/leemysw/feishu-docx) ★ 213 — Feishu (Lark) docs / sheet / bitable ↔ Markdown with Claude Skills support
